...
AGENT_VERSION="${CYBERFUSION_AGENT_VERSION:-0.1.0-dev}"
AGENT_PROFILE="${CYBERFUSION_AGENT_PROFILE:-full}"
...
CYBERFUSION_AGENT_VERSION=${AGENT_VERSION}
CYBERFUSION_AGENT_PROFILE=${AGENT_PROFILE}
EOF
