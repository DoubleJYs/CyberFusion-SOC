...
const componentRegistry: Record<string, ComponentLoader> = {
  ...
  'soc/UserWorkspaceView': () => import('@/views/soc/UserWorkspaceView.vue'),
  ...
  'soc/HostAgentInstallView': () => import('@/views/soc/HostAgentInstallView.vue'),
...
export const fallbackProtectedRoutes: AppRouteRecord[] = [
  { path: 'soc/user-workspaces', name: 'socUserWorkspaces', component: componentRegistry['soc/UserWorkspaceView'], meta: { title: '用户工作区', requiresAuth: true, permissions: ['soc:dashboard:view'] } },
  ...
  { path: 'soc/rules', name: 'socRules', component: componentRegistry['soc/RuleCenterView'], meta: { title: '检测内容规则设置', requiresAuth: true, permissions: ['soc:rules:view', 'soc:external-event:view'] } },
  ...
  { path: 'soc/agents/install', name: 'socHostAgentInstall', component: componentRegistry['soc/HostAgentInstallView'], meta: { title: 'Agent 安装命令设置与建立', requiresAuth: true, permissions: ['soc:agent:register'] } },
