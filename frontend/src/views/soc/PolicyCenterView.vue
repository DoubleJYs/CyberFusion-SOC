...
const riskWeightFields = [
  ...
  { key: 'incidentOpenWeight', label: '未关闭事件簇' },
  { key: 'incidentHighWeight', label: '高危事件簇' },
  { key: 'overdueTicketWeight', label: '超时工单' },
  { key: 'openPlaybookTaskWeight', label: '未完成剧本任务' },
  { key: 'employeePendingTaskWeight', label: '员工待办' },
  { key: 'clientCheckupWarningWeight', label: '员工体检注意' },
  { key: 'clientCheckupCriticalWeight', label: '员工体检严重' },
...
function defaultRiskForm() {
  return {
    ...
    incidentOpenWeight: 12,
    incidentHighWeight: 20,
    overdueTicketWeight: 10,
    openPlaybookTaskWeight: 6,
    employeePendingTaskWeight: 8,
    clientCheckupWarningWeight: 8,
    clientCheckupCriticalWeight: 16,
...
function riskPayload(): RiskScoringPolicyPayload {
  return {
    ...
    incidentOpenWeight: riskForm.incidentOpenWeight,
    incidentHighWeight: riskForm.incidentHighWeight,
    ...
    clientCheckupWarningWeight: riskForm.clientCheckupWarningWeight,
    clientCheckupCriticalWeight: riskForm.clientCheckupCriticalWeight,
