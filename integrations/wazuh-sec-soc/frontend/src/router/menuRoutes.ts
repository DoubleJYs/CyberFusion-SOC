...
export const fallbackProtectedRoutes: AppRouteRecord[] = [
  ...
  { path: 'soc/alerts', name: 'socAlerts', component: componentRegistry['soc/AlertCenterView'], meta: { title: '告警中心', requiresAuth: true, permissions: ['soc:alert:view'] } },
  ...
  { path: 'soc/external-events', name: 'socExternalEvents', component: componentRegistry['soc/ExternalEventView'], meta: { title: '外部事件', requiresAuth: true, permissions: ['soc:external-event:view'] } },
  ...
  { path: 'soc/reports', name: 'socReports', component: componentRegistry['soc/ReportView'], meta: { title: '报表中心', requiresAuth: true, permissions: ['soc:report:view'] } },
...
export function firstRoutePathFromMenus(menus: MenuItem[]) {
  const route = buildRoutesFromMenus(menus)[0]
